    ...
    return (
      <div>
        <div style={segmentInfo.charCount > 1600 ? { color: "red" } : {}}>
            <b>IMPORTANT! Due to changes in our phone service provider policy, you are now REQUIRED to include the following text at the end of your initial message: Reply STOP to unsubscribe</b><br />
